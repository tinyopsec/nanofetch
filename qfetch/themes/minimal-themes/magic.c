...
// Magical purple gradient with mystical colors
#define COLOR_MAGIC1  "\033[38;2;138;43;226m"   // Blue Violet
#define COLOR_MAGIC2  "\033[38;2;147;112;219m"  // Medium Purple
#define COLOR_MAGIC3  "\033[38;2;160;32;240m"   // Purple
#define COLOR_MAGIC4  "\033[38;2;186;85;211m"   // Medium Orchid
#define COLOR_MAGIC5  "\033[38;2;148;0;211m"    // Dark Violet
#define COLOR_MAGIC6  "\033[38;2;75;0;130m"     // Indigo
#define COLOR_MAGIC7  "\033[38;2;102;51;153m"   // Rebecca Purple
#define COLOR_MAGIC8  "\033[38;2;72;61;139m"    // Dark Slate Blue
...
static const char* magic_colors[] = {
    COLOR_MAGIC1, COLOR_MAGIC2, COLOR_MAGIC3, COLOR_MAGIC4,
    COLOR_MAGIC5, COLOR_MAGIC6, COLOR_MAGIC7, COLOR_MAGIC8
};

const char* get_magic_color(int index) {
    return magic_colors[index & 7]; // Use bitwise AND for faster modulo
}

void print_magic_header() {
    printf("\033[2J\033[H"); // Clear screen
    
    // ASCII art header with gradient - MAGIC
...
void print_info_line(const char* label, const char* value, int color_index) {
    printf("%s%s%-12s%s%s%s%s\n", 
           COLOR_BOLD, get_magic_color(color_index), label, 
