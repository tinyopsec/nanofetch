...
// Rose red gradient with romantic pink and red tones
#define COLOR_ROSE1  "\033[38;2;255;20;147m"   // Deep Pink
#define COLOR_ROSE2  "\033[38;2;255;105;180m"  // Hot Pink
#define COLOR_ROSE3  "\033[38;2;255;182;193m"  // Light Pink
#define COLOR_ROSE4  "\033[38;2;255;192;203m"  // Pink
#define COLOR_ROSE5  "\033[38;2;220;20;60m"    // Crimson
#define COLOR_ROSE6  "\033[38;2;178;34;34m"    // Fire Brick
#define COLOR_ROSE7  "\033[38;2;139;0;0m"      // Dark Red
#define COLOR_ROSE8  "\033[38;2;165;42;42m"    // Brown Red
...
static const char* rose_colors[] = {
    COLOR_ROSE1, COLOR_ROSE2, COLOR_ROSE3, COLOR_ROSE4,
    COLOR_ROSE5, COLOR_ROSE6, COLOR_ROSE7, COLOR_ROSE8
};

const char* get_rose_color(int index) {
    return rose_colors[index & 7]; // Use bitwise AND for faster modulo
}

void print_rose_header() {
    printf("\033[2J\033[H"); // Clear screen
    
    // ASCII art header with gradient - LOVE instead of LAVA
...
void print_info_line(const char* label, const char* value, int color_index) {
    printf("%s%s%-12s%s%s%s%s\n", 
           COLOR_BOLD, get_rose_color(color_index), label, 
